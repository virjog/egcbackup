...
<?php
	...
	if( $name !="" && $email !="")
	{
		...
		if ( $fp )
		{
			...
			$message = $message. "You can view the updated list at http://coewww.rutgers.edu/egc/meche.csv";
...
<form method="post" action="<?php $PHP_SELF;?>">
	...
	Professor: <select name="professor">
		<option selected>Dr. William J. Bottega</option>
		<option>Dr. Jerry Shan</option>
		<option>Dr. Tobias Rossmann</option>
		<option>Dr. Stephen D. Tse</option>
	</select><br><br>
