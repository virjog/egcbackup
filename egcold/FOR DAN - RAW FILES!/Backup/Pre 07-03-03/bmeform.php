...
<?php
	...
	if( $name !="" && $email !="")
	{
		...
		if ( $fp )
		{
			...
			$message = $message. "You can view the updated list at http://coewww.rutgers.edu/egc/bmw.csv";
...
<form method="post" action="<?php $PHP_SELF;?>">
	...
	Professor: <select name="professor">
		<option selected>Dr. Sobin Kim</option>
		<option>Dr. Anant Madabhushi</option>
		<option>Dr. David I. Shreiber</option>
		<option>Dr. Gary M. Drzewiecki</option>
