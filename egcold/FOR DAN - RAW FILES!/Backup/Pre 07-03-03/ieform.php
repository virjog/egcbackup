...
<?php
	...
	if( $name !="" && $email !="")
	{
		...
		if ( $fp )
		{
			...
			$message = $message. "You can view the updated list at http://coewww.rutgers.edu/egc/ie.csv";
...
<form method="post" action="<?php $PHP_SELF;?>">
	...
	Professor: <select name="professor">
		<option selected>Dr. James Luxhoj</option>
		<option>Dr. Susan Albin</option>
		<option>Dr. Elsayed A.</option>
		<option>Dr. David Coit</option>
	</select><br><br>
