...
<?php
	...
	if( $name !="" && $email !="")
	{
		...
		if ( $fp )
		{
			...
			$message = $message. "You can view the updated list at http://coewww.rutgers.edu/egc/mate.csv";
...
<form method="post" action="<?php $PHP_SELF;?>">
	...
	Professor: <select name="professor">
		<option selected>Dr. Matthewson</option>
		<option>Dr. Garofalini</option>
		<option>Dr. Klein</option>
		<option>Dr. Mayo</option>
	</select><br><br>
