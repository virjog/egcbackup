...
<?php
	...
	if( $name !="" && $email !="")
	{
		...
		if ( $fp )
		{
			...
			$message = $message. "You can view the updated list at http://coewww.rutgers.edu/egc/ece.csv";
...
<form method="post" action="<?php $PHP_SELF;?>">
	...
	Professor: <select name="professor">
		<option selected>Dr. Yicheng Lu</option>
		<option>Dr. Predrag Spasojevic</option>
		<option>Dr. Yangyong Zhang</option>
		<option>Dr. Sophocles Orfanidis</option>
	</select><br><br>
