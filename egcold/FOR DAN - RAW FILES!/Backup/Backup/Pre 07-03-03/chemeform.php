...
<?php
	...
	if( $name !="" && $email !="")
	{
		...
		if ( $fp )
		{
			...
			$message = $message. "You can view the updated list at http://coewww.rutgers.edu/egc/cheme.csv";
...
<form method="post" action="<?php $PHP_SELF;?>">
	...
	Professor: <select name="professor">
		<option selected>Dr. Pedersen</option>
		<option>Dr. Chiew</option>
		<option>Dr. Marianthi Ierapetritou</option>
		<option>Dr. Alkis Constantinides</option>
	</select><br><br>
