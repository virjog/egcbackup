...
<?php include("menu.php"); ?>
		<div id="body">
			<div id="content">
				<div class="title"><span>Mission Statement</span></div>
				
				<div style="font-weight: bold; font-size: 1.1em; text-align: center; width: 100%;">
					2007 – 2008 Mission Statement<br />
				...
				<div style="margin-top: 1.2em;">President Spatocco's <a href="stratigicPlan.php">Stratigic Plan</a></div>
			</div>
		</div>
	</div>
