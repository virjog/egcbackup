...
<?php include("menu.php"); ?>
		<div id="body">
		         ...
		         <!-- <center><a href="https://cas.rutgers.edu/login?service=http://www.bitballot.com/process/login/rutgers"><img src="/images/Teach.jpg"> </a></center> -->
		           

		
		
			<div id="content">
				<div style="text-indent: 20px;"><em><strong> <span class="style2 style4">The Engineering Governing Council (EGC)</span> <span class="style4">is the governing body of the Rutgers University School of Engineering on the New Brunswick/Piscataway Campus. The EGC:</span></strong></em></div> 
<ul class="style4">
			...
			<li><em>Distributes funds to Engineering societies and organizations.</em></li>
                ...
                <div class="contentdiv" align="center">
                    ...
                    <div class="contentdiv">
                		<img src="sliderImg/img7.jpg" height="300" width="325" />                	</div>
                                        <div class="contentdiv">
                		<img src="sliderImg/img8.jpg" height="300" width="325" />                	</div>
                </div>
